...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/copilot.vim",
    url = "https://github.com/github/copilot.vim"
  },
  harpoon = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/theprimeagen/harpoon"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/home/christian/.local/share/nvim/site/pack/packer/start/rose-pine",
